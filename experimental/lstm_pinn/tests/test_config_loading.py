...
from src.models.lstm_pinn.config import LSTMPINNConfig
...
class TestConfigFiles(unittest.TestCase):
    ...
    def test_device_calibrated_physics_config(self):
        config_path = 'config/device_calibrated_physics.json'
    ...
    def test_lstm_dynamic_response_config(self):
        config_path = 'config/lstm_dynamic_response.json'
        self.assertTrue(os.path.exists(config_path))
        
        lstm_config = LSTMPINNConfig.from_json(config_path)
        
        self.assertEqual(lstm_config.lstm.input_dim, 2)
        self.assertEqual(lstm_config.lstm.hidden_dim, 128)
        self.assertEqual(lstm_config.sequence.length, 50)
        self.assertEqual(lstm_config.training.epochs, 30000)
        self.assertEqual(lstm_config.materials.theta0, 120.0)
        self.assertAlmostEqual(lstm_config.geometry.Lx, 0.000174)
